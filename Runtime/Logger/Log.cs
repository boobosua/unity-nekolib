...
{
    /// <summary>
    /// Conditional logger. Info, Warn, and Assert are stripped in release builds (unless TRNK_LOG is defined).
    ...
    public static class Log
    {
        ...
        [Conditional("UNITY_EDITOR"), Conditional("DEVELOPMENT_BUILD"), Conditional("TRNK_LOG")]
