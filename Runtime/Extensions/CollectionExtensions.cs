...
namespace NekoLib.Extensions
{
    public static class CollectionExtensions
    {
        ...
        #region Grid<T>
        /// <summary>Checks if the grid contains the specified element.</summary>
        ...
        /// <summary>Returns the (x, y) index of the specified element in the grid; throws if not found.</summary>
        ...
        /// <summary>Returns the last (x, y) index of the specified element in the grid; throws if not found.</summary>
        ...
        /// <summary>Tries to find the last occurrence of the specified element scanning from the end.</summary>
        ...
        /// <summary>Returns the first element of the grid.</summary>
        ...
        /// <summary>Returns the last element of the grid.</summary>
        ...
        /// <summary>Checks if the grid is null or empty.</summary>
        public static bool IsNullOrEmpty<T>(this Grid<T> grid)
        {
            return grid == null || grid.Width == 0 || grid.Height == 0;
        }

        /// <summary>Checks if the grid contains any null elements.</summary>
        ...
        /// <summary>Returns a string representation of a grid. Does not work on nested grids or grid that is nested in other structures.</summary>
