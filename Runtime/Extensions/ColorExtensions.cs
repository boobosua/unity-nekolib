...
namespace NekoLib.Extensions
{
    public static class ColorExtensions
    {
        ...
        /// <summary>Add values to RGB components with clamping.</summary>
        ...
        /// <summary>Get perceived brightness using luminance formula.</summary>
        public static float GetLuminance(this Color color)
        {
            return 0.299f * color.r + 0.587f * color.g + 0.114f * color.b;
        }

        /// <summary>Invert color (preserves alpha).</summary>
        public static Color Invert(this Color color)
        {
            return new(1f - color.r, 1f - color.g, 1f - color.b, color.a);
        }

        /// <summary>Convert to grayscale using luminance.</summary>
