...
namespace NekoLib.Extensions
{
    public static class Vector3Extensions
    {
        ...
        /// <summary>Divides the current vector by the specified components.</summary>
        ...
        /// <summary>Rotates the vector around the X-axis by the given angle in degrees.</summary>
        ...
        /// <summary>Rotates the vector around the Z-axis by the given angle in degrees.</summary>
        ...
        /// <summary>Checks if this point is inside a sphere.</summary>
        public static bool IsInsideSphere(this Vector3 point, Vector3 center, float radius)
        {
            return point.InRangeOf(center, radius);
        }

        /// <summary>Checks if this point is inside a box defined by center and size.</summary>
